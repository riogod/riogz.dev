import type { IRoute, IRoutes, IMenuConfig, RouterDependencies } from './interfaces';
...
export type { IRoute, IRoutes, IMenuConfig, IOnEnterMiddlewareConfig, IOnPathMiddlewareConfig, IOnSyncPathMiddlewareConfig, ITitleMiddlewareConfig, IPrivateRouteMiddlewareConfig, RouterDependencies, };
